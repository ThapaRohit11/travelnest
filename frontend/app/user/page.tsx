  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section id="about" className="px-6 py-14 sm:px-8">
          <div className="mx-auto max-w-[1200px]">
            ...
            <div id="hotels" className="mt-10 grid gap-6 md:grid-cols-3">
        ...
        <section id="booking" className="bg-slate-100/80 px-6 py-16 sm:px-8">
          <div className="mx-auto max-w-[1200px] text-center">
            ...
            <div id="profile" className="mt-10 grid gap-4 md:grid-cols-4">
